...
// @ts-ignore
import { __SPACETIMEDB__, AlgebraicType, ProductType, BuiltinType, ProductTypeElement, SumType, SumTypeVariant, IDatabaseTable, AlgebraicValue, ReducerEvent, Identity, Address } from "@clockworklabs/spacetimedb-sdk";
...
export class Message extends IDatabaseTable
{
	...
	{
		return __SPACETIMEDB__.clientDB.getTable("Message").getInstances() as unknown as Message[];
	}

	public static filterBySender(value: Identity): Message[]
	{
		let result: Message[] = [];
		for(let instance of __SPACETIMEDB__.clientDB.getTable("Message").getInstances())
		{
	...
	public static onInsert(callback: (value: Message, reducerEvent: ReducerEvent | undefined) => void)
	{
		__SPACETIMEDB__.clientDB.getTable("Message").onInsert(callback);
	}

	public static onUpdate(callback: (oldValue: Message, newValue: Message, reducerEvent: ReducerEvent | undefined) => void)
	{
		__SPACETIMEDB__.clientDB.getTable("Message").onUpdate(callback);
	}

	public static onDelete(callback: (value: Message, reducerEvent: ReducerEvent | undefined) => void)
	{
		__SPACETIMEDB__.clientDB.getTable("Message").onDelete(callback);
	}

	public static removeOnInsert(callback: (value: Message, reducerEvent: ReducerEvent | undefined) => void)
	{
		__SPACETIMEDB__.clientDB.getTable("Message").removeOnInsert(callback);
	}

	public static removeOnUpdate(callback: (oldValue: Message, newValue: Message, reducerEvent: ReducerEvent | undefined) => void)
	{
		__SPACETIMEDB__.clientDB.getTable("Message").removeOnUpdate(callback);
	}

	public static removeOnDelete(callback: (value: Message, reducerEvent: ReducerEvent | undefined) => void)
	{
